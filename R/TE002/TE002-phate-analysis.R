...
# create_workspace(run_dir = "TE002-phate-analysis")

## GEX PHATE ----
print_msg_info(">>> PHATE Analysis on Gene Expression")
{
	my_seurat.obj <- readRDS("~/Clouds/Dropbox/Data/isc/TE002/TE002-seurat-analysis-data.rds")
	...
	pdf( file.path(reports.dir,"TE002-ges-phate-clusters.pdf"))
		print(p)
	dev.off()
	...
	pdf( file.path(reports.dir,"TE002-ges-phate-Lgr5.pdf"))
		print(p)
	dev.off()	
	...
	pdf( file.path(reports.dir,"TE002-ges-phate-Top2a.pdf"))
		print(p)
	dev.off()		
...
print_msg_info(">>> PHATE Analysis on Protein Activity")
{
	...
	my_seurat.obj <- readRDS("~/Clouds/Dropbox/Data/isc/TE002/TE002-seurat-viper-analysis-with-metacell-data.rds")
	my_metadata.filename <- "~/Clouds/Dropbox/Data/isc/TE002/TE002-viper-analysis-with-metacell-metadata.rds"
	...
	df$sc_entropy <- my_metadata.obj$sc_entropy
	...
	pdf( file.path(reports.dir,"TE002-pas-phate.pdf"))
		print(p)
	dev.off()
...
print_msg_info(">>> Plots of Entropy on PAS")
{
	...
	pdf( file.path(reports.dir,"TE002-pas-phate-sc-entropy.pdf"))
		print(p)
	dev.off()	
	...
	pdf( file.path(reports.dir,"TE002-pas-phate-stemness-index.pdf"))
		print(p)
	dev.off()		
	...
	pdf( file.path(reports.dir,"TE002-pas-phate-clusters-facets.pdf"))
		print(p)
	dev.off()	
	...
	pdf( file.path(reports.dir,"TE002-pas-phate-clusters-boxplots-entropy.pdf") , width = 6 )
		print(p)
	dev.off()		
	...
	pdf( file.path(reports.dir,"TE002-pas-phate-clusters-boxplots-stemness.pdf") , width = 6 )
		print(p)
	dev.off()	
	...
	print_msg_warn(">>> Updating metadata file")
	{
		...
		write_csv( my_metadata.obj , "~/Clouds/Dropbox/Data/isc/TE002/TE002-metadata-with-metacell-all-analysis.csv")
	}
}

# filename <- "~/Clouds/Dropbox/Data/isc/TE002/TE002-metadata-with-metacell-all-analysis-processed.csv"
filename <- "~/Clouds/Dropbox/Data/isc/TE002/TE002-metadata-with-metacell-all-analysis.csv"
file.info(filename)
x <- read_csv(filename)
