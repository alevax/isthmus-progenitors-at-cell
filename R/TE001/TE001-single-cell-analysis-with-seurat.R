...
# -------------------------------------
# system.time({source("sources/ermanno-data-analysis/TE001/TE001-single-cell-analysis-with-seurat.R")})
	...
	print_msg_info(">>> Loading umi counts matrix")
	{
		if ( !file.exists(cpm_filename) )
		{
			...
			# x <- read_csv("~/Clouds/Dropbox/Data/isc/TE001/TE001-doublets-df.csv")
