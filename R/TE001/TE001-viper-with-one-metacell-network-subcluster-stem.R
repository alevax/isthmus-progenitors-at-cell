## 
# Single cell Analysis of TE001 (VIPER Analysis) | SUBLUSTER STEM
# ---------------------------------------------------------------
...
# ------------------------------------------------------------------------
# system.time({ source("sources/ermanno-data-analysis/TE001/TE001-viper-with-one-metacell-network-subcluster-stem.R") })
...
print_msg_info(">>> Setting constants and paramters [in YAML]")
{
	...
	my_params.list$comments <- "subClusterSTEM-C1"
...
message(">> VIPER Analysis with Seurat")
{
	...
	# vp_data_dist.matrix <- vpdist_vpsim
