...
# library(Seurat)
# 
# data_dir <- '~/Clouds/Dropbox/Data/isc/bottcher-2021/ctrl1/'
...
##
# Analysis of Bottcher 2021 samples with SEURAT
# ---------------------------------------------
# system.time({source("sources/bottcher-2021/sample-1-single-cell-analysis-with-seurat.R")})
	...
	print_msg_info(">>> Setting constants and paramters")
	{
		...
		set.seed(my_seed)
		knn_n_neighbor <- 15
		my_data_dir <- file.path("~/Clouds/Dropbox/Data/isc/bottcher-2021",my_sample_id)
