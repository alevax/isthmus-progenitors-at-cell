---
title: "gene-expr-clustering-Seurat.R"
output:
  pdf_document: default
  html_notebook: default
---

This [R Markdown](http://rmarkdown.rstudio.com) Notebook reproduces the analysis of TE001 at the gene expression level. The first section of the Tutorial makes use of the default parameters of the Seurat pipeline. The second part of the tutorial finds a close-to-optimal clustering solution obtained with the Louvain algorithm, by returning the solution with the highest silhouette by optimizing over two parameters, the number of nearest neighbors (`NN`) and the resolution (`res`).
...
[Clustering (iteration 1)]{.underline}:
...
[Clustering (iteration 2)]{.underline}:
